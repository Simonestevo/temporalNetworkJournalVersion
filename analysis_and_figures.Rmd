...
heatmapPlot <- ggplot(heatmapData, aes(x = Comparison, y = name, fill = Z)) +
  ...
  labs(x = "Daily TWSA Comparison", y = "Arrival location") +
   ...
   scale_fill_manual(values = jurPal) +
    ...
    if(saveOutputs == TRUE) {
      ggsave(file.path(manuscriptFigures, 
                       paste0(Sys.Date(), "-", "figure4Boxplots.png")), 
...
bxp <- ggboxplot(modBoxplotInputData, x = "season", y = "weight",
  ...
  facet_wrap(~name, scales = "free_y", nrow = 3) +
   scale_fill_manual(values = jurPal) +
    ...
    if(saveOutputs == TRUE) {
      ggsave(file.path(manuscriptFigures, 
                       paste0(Sys.Date(), "-", "figure3Boxplots.png")), 
   ...
   scale_fill_manual(values = jurPal) +
    ...
    if(saveOutputs == TRUE) {
      ggsave(file.path(supportingFigures,
                       paste0(Sys.Date(), "-", saveLabel, "supportingInfoBoxplots.png")),
...
## Fig 5: Seasonal spawning data and maps
